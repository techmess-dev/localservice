		...
		<div className="flex flex-col dark:bg-gray-900 min-h-screen max-h-screen font-mono" >
			...
			<div className="flex flex-grow flex-col gap-6 font-sans px-4 pt-6">
				...
				<div className="flex flex-col flex-grow justify-items-center items-center  gap-4">
					...
					<p className="font-extrabold text-lg from-neutral-900  text-purple-900 dark:text-slate-500 opacity-65 dark:opacity-100">From AC installation to wiring, fan repair to water purifier servicing — we deliver trusted, affordable, and on-time solutions for your home and office.</p>
